...
<div class="wrap">
  ...
  <div class="form-wrap">
	...
	if (isset($_POST['WidgetMaster_form_submit']) && $_POST['WidgetMaster_form_submit'] == 'yes')
	{
		...
		$WidgetMaster_On_Homepage = stripslashes($_POST['WidgetMaster_On_Homepage']);
		$WidgetMaster_On_Posts = stripslashes($_POST['WidgetMaster_On_Posts']);
		$WidgetMaster_On_Pages = stripslashes($_POST['WidgetMaster_On_Pages']);
		$WidgetMaster_On_Search = stripslashes($_POST['WidgetMaster_On_Search']);
		$WidgetMaster_On_Archives = stripslashes($_POST['WidgetMaster_On_Archives']);
		$WidgetMaster_Icon_Align = stripslashes($_POST['WidgetMaster_Icon_Align']);
		$WidgetMaster_Border_Color = stripslashes($_POST['WidgetMaster_Border_Color']);
                $WidgetMaster_Icon_padding = stripslashes($_POST['WidgetMaster_Icon_padding']);
                $WidgetMaster_Icon_size = stripslashes($_POST['WidgetMaster_Icon_size']);
                $WidgetMaster_Icon_Open = stripslashes($_POST['WidgetMaster_Icon_Open']);
                $WidgetMaster_Icon_Close = stripslashes($_POST['WidgetMaster_Icon_Close']);
                $WidgetMaster_Icon_color = stripslashes($_POST['WidgetMaster_Icon_color']);
                $WidgetMaster_Icon_Bg_color = stripslashes($_POST['WidgetMaster_Icon_Bg_color']);
		$WidgetMaster_Border_Radius = stripslashes($_POST['WidgetMaster_Border_Radius']);
